...
JsAccountAggregate.getMonthlyItemSalesList(year, month, id, f_callback){
	WebAccountAggregate.getMonthlyItemSalesList(year, month, id, {
		callback: function(ret){
			var sum = 0;
...
JsAccountAggregate.getMonthlyItemAccount(year, month, id, f_callback){
	WebAccountAggregate.getMonthlyMemberAccount(year, month, id, {
		callback: function(ret){
			var sum = 0;
